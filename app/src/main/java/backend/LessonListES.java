...
public class LessonListES implements LessonList {
	...
	ArrayList<String> ES_sent3 = new ArrayList<String>(Arrays.asList(
			"Yo bebo el café.", "Tú quieres té.", "Ellos quieren un café.", "El café es negro.", "La leche es blanca.", "La leche y el café"));
	...
	ArrayList<String> ES_sent4 = new ArrayList<String>(Arrays.asList(
			"Yo estoy en la biblioteca.", "Quiero leer un libro.", "¿Quién eres?", "Yo no tengo una botella de leche.", "Él tiene tres libros.", "Ellos leen mucho."));
